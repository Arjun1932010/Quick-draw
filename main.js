...
var random_no= Math.floor((Math_random()*quick_draw_data_set.length)+1);
...
function gotResults(error,results){
  if(error){
    ...
    document.getElementById("confidence").innerHTML="Confidence: "+ Math_round(results[0].confidence*100)+ "%";
  }
}